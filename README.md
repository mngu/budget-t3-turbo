...
> Packages in this monorepo are namespaced under `@budget`.
...
pnpm --filter @budget/auth generate
```
...
3. Outputs a Drizzle-compatible schema file to the `@budget/db` package
