...
function FieldTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="field-label"
      className={cn(
        "text-body flex w-fit items-center gap-2 font-semibold group-data-[disabled=true]/field:opacity-50",
        className,
      )}
      {...props}
    />
...
function FieldSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "text-control relative -my-2 h-5 group-data-[variant=outline]/field-group:-mb-2",
        className,
      )}
      {...props}
    >
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-destructive text-control", className)}
      {...props}
    >
      {content}
    </div>
