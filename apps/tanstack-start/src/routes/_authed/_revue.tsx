...
/**
 * Coque des écrans de la revue (revue épurée, revue du mois, « À revoir », zoom
 ...
 *
 * Layout sans segment d'URL : `/`, `/transactions`, `/classer`, `/revue-epuree`
 * et `/categorie/$name` restent à la racine. `/banques` et `/categories` sont
...
// `/categorie/$name` n'en ont plus depuis que la rangée est réduite à deux
// entrées : elles gardent l'en-tête complet, sans rien de surligné.
//
// Lecture du pathname et non `useMatchRoute` : celui-ci compare aussi la search
// et renvoyait `false` sur `/revue-epuree?dateFrom=…`, laissant l'icône éteinte
// sur sa propre page — un échec silencieux, sans erreur ni type qui l'attrape.
//
