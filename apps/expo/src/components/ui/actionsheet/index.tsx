...
// Le slot Icon généré par createActionsheet perd ses props avec le typage de
// nativewind 5.0.0-preview.4 — cast local, sans impact runtime.
const UIActionsheetIcon = UIActionsheet.Icon as React.ComponentType<
  IActionsheetIconProps & { ref?: React.Ref<unknown> }
>;
