...
// Le slot Icon généré perd ses props avec le typage de nativewind
// 5.0.0-preview.4 — cast local, sans impact runtime.
const UIButtonIcon = UIButton.Icon as React.ComponentType<
  IButtonIcon & { size?: number | string; ref?: React.Ref<unknown> }
>;
